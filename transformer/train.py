...
# load data
data = RawDataset(
    "/home/philipp/Documents/caffeine-sleep/transformer/raw-nsamp_19229-subj_1100*-stage_*-cond_*.dat",
    "/home/philipp/Documents/caffeine-sleep/transformer/label-nsamp_19229-subj_1100*-stage_*-cond_*.csv",
)
